...
# * Files in the jni/libjpeg-turbo150, jni/libusb, jin/libuvc, jni/rapidjson folder may have a different license, see the respective files.
#*/

######################################################################
# libjpeg-turbo150_static.a
######################################################################
...
#生成するモジュール名
LOCAL_MODULE    := jpeg_turbo_150_static
...
# simd/jsimd.h simd/jcolsamp.inc simd/jsimdcfg.inc.h simd/jsimdext.inc
# simd/jdct.inc jsimdext.inc jcolsamp.inc jdct.inc \
...
# to avoid NDK issue(no need for static library)
LOCAL_LDLIBS := -L$(SYSROOT)/usr/lib -ldl

LOCAL_WHOLE_STATIC_LIBRARIES = jpeg_turbo_150_static

LOCAL_MODULE := jpeg_turbo_150
