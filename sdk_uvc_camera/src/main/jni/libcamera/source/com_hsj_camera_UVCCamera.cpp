...
static jint
nativeSetStatusCallback(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jobject jIStatusCallback) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetButtonCallback(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jobject jIButtonCallback) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
//Add by Hsj
static jint nativeSetPreviewRotate(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint rotate) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
        result = camera->setPreviewRotate(rotate);
    }
    RETURN(result, jint)
}

//Add by Hsj
static jint nativeSetPreviewFlip(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint flip) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
        result = camera->setPreviewFlip(flip);
    }
    RETURN(result, jint)
}
...
static jint nativeSetPreviewSize(JNIEnv *env, jobject thiz,
                                 ...
                                 jint min_fps, jint max_fps, jint mode, jfloat bandwidth) {
...
static jint
nativeSetPreviewDisplay(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jobject jSurface) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetFrameCallback(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jobject jIFrameCallback,jint pixel_format) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetCaptureDisplay(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jobject jSurface) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetExposureMode(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint exposureMode) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetExposurePriority(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint priority) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetExposure(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint exposure) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
// Java method correspond to this function should not be a static method
static jint nativeUpdateAutoWhiteBalanceLimit(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetAutoWhiteBalance(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jboolean autofocus) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeGetAutoWhiteBalance(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeGetAutoWhiteBalanceCompo(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetAutoContrast(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jboolean autocontrast) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
// Java method correspond to this function should not be a static method
static jint nativeUpdateWhiteBalanceLimit(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetWhiteBalance(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint whiteBalance) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeGetWhiteBalance(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = 0;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
// Java method correspond to this function should not be a static method
static jint nativeUpdateWhiteBalanceCompoLimit(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetWhiteBalanceCompo(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint whiteBalance_compo) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeGetWhiteBalanceCompo(JNIEnv *env, jobject thiz, ID_TYPE id_camera) {
    jint result = 0;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetBacklightComp(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint backlight_comp) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetPowerlineFrequency(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint frequency) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetDigitalMultiplier(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint multiplier) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint nativeSetDigitalMultiplierLimit(JNIEnv *env, jobject thiz, ID_TYPE id_camera,
...
static jint
nativeSetAnalogVideoStandard(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint standard) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static jint
nativeSetAnalogVideoLockState(JNIEnv *env, jobject thiz, ID_TYPE id_camera, jint state) {
    jint result = JNI_ERR;
    ENTER()
    UVCCamera *camera = reinterpret_cast<UVCCamera *>(id_camera);
    if (LIKELY(camera)) {
...
static JNINativeMethod methods[] = {
        ...
        {"nativeSetStatusCallback",                 "(JLcom/hsj/camera/IStatusCallback;)I", (void *) nativeSetStatusCallback},
        {"nativeSetButtonCallback",                 "(JLcom/hsj/camera/IButtonCallback;)I", (void *) nativeSetButtonCallback},
